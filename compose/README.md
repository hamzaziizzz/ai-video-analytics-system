# Running AI Video Analytics with docker-compose
...
3. `docker-compose-multi-gpu.yml` - start 2 containers on 2 GPUs and add NGINX container as load balancer
...
When you run AI Video Analytics on multiple GPUs docker-compose creates one container per GPU,
...
All configs related to detection, num workers, etc., are located in `.env` file.
