...
This directory contains practical examples demonstrating how to use the AI Video Analytics client library in various scenarios. Each example focuses on solving specific real-world problems using the person detection API.
...
This example demonstrates how to efficiently process large image collections using asynchronous I/O and parallel API requests. It implements a production-ready pipeline for batch processing thousands of images through a person detection API.
...
1. Verify the AI Video Analytics server is running
